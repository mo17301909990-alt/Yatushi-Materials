...
export const wearResistantGoldPaperMappingApi = {
  ...
  getAllMappings: (): Promise<WearResistantGoldPaperMapping[]> => {
    return request.get('/api/wear-resistant-gold-paper-mapping')
  },
  ...
  getMappingsWithPagination: (page: number, size: number): Promise<PaginationResponse<WearResistantGoldPaperMapping>> => {
    return request.get('/api/wear-resistant-gold-paper-mapping/pagination', {
      params: { page, size }
    })
  },
  ...
  getMappingById: (id: number): Promise<WearResistantGoldPaperMapping> => {
    return request.get(`/api/wear-resistant-gold-paper-mapping/${id}`)
  },
  ...
  createMapping: (data: CreateWearResistantGoldPaperMapping): Promise<WearResistantGoldPaperMapping> => {
    return request.post('/api/wear-resistant-gold-paper-mapping', data)
  },
  ...
  updateMapping: (id: number, data: UpdateWearResistantGoldPaperMapping): Promise<WearResistantGoldPaperMapping> => {
    return request.put(`/api/wear-resistant-gold-paper-mapping/${id}`, data)
  },
  ...
  deleteMapping: (id: number): Promise<void> => {
    return request.delete(`/api/wear-resistant-gold-paper-mapping/${id}`)
  },
  ...
  batchDeleteMappings: (ids: number[]): Promise<{ success: boolean; message: string }> => {
    return request.delete('/api/wear-resistant-gold-paper-mapping/batch', { data: ids })
  },
  ...
  searchMappings: (params: SearchParams): Promise<WearResistantGoldPaperMapping[]> => {
    return request.get('/api/wear-resistant-gold-paper-mapping/search', { params })
  },
  ...
  checkUnique: (
    ...
    return request.get('/api/wear-resistant-gold-paper-mapping/check-unique', {
  ...
  batchUpdateStatus: (data: BatchUpdateStatusRequest): Promise<{ success: boolean; message: string }> => {
    return request.put('/api/wear-resistant-gold-paper-mapping/batch/status', data)
  },
  ...
  getAllGoldPaperTypes: (): Promise<string[]> => {
    return request.get('/api/wear-resistant-gold-paper-mapping/options/gold-paper-types')
  },
  ...
  getSkipPaperTypes: (): Promise<string[]> => {
    return request.get('/api/wear-resistant-gold-paper-skip-config')
  },
  ...
  saveSkipPaperTypes: (paperTypes: string[]): Promise<void> => {
    return request.put('/api/wear-resistant-gold-paper-skip-config', paperTypes)
  },
  ...
  exportMappings: (): Promise<Blob> => {
    return request.get('/api/wear-resistant-gold-paper-mapping/export', {
      responseType: 'blob'
    })
  },
  ...
  downloadImportTemplate: (): Promise<Blob> => {
    return request.get('/api/wear-resistant-gold-paper-mapping/import-template', {
      responseType: 'blob'
    })
  },
  ...
  importMappings: (file: File): Promise<{
    ...
    return request.post('/api/wear-resistant-gold-paper-mapping/import', formData, {
      headers: {
